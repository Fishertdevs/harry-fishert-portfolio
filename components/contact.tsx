  ...
  return (
    <section id="contact" className="relative flex flex-col justify-center py-8 md:py-12 bg-white dark:bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        {/* Social Icons */}
        <motion.div 
          className="flex justify-center gap-4 mb-4 md:mb-6"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <a 
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
          >
            <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700 dark:text-gray-300" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a 
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
          >
            <WhatsAppIcon className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700 dark:text-gray-300" />
          </a>
        </motion.div>
