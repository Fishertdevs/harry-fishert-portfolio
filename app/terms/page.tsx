            ...
            {language === "es" ? (
              <>
                ...
                <AnimatedSection delay={0.3}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">1. Aceptación de los Términos</h2>
                ...
                <AnimatedSection delay={0.4}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">2. Uso del Sitio</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.5}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">3. Propiedad Intelectual</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.6}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">4. Limitación de Responsabilidad</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.7}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">5. Modificaciones</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.8}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">6. Contacto</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
              ...
              <>
                ...
                <AnimatedSection delay={0.3}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">1. Acceptance of Terms</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.4}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">2. Use of the Site</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.5}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">3. Intellectual Property</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.6}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">4. Limitation of Liability</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.7}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">5. Modifications</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
                ...
                <AnimatedSection delay={0.8}>
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mt-6 md:mt-8 mb-3 md:mb-4">6. Contact</h2>
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-3 md:mb-4">
