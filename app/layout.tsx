...
export default function RootLayout({
  ...
  return (
    <html lang="es" suppressHydrationWarning>
      ...
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-8e329a34-d3b5-478f-8d34-bfd71d2cf28e" style="
...
">
<a
  href="https://v0.dev/chat/api/open/built-with-v0/b_JyNc11Zm1vu"
  target="_blank"
...
<button
  onclick="document.getElementById('v0-built-with-button-8e329a34-d3b5-478f-8d34-bfd71d2cf28e').style.display='none'"
