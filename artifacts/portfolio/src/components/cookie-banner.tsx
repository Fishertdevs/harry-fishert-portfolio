      ...
      <div className="container mx-auto px-3 py-2 md:px-6 md:py-4">
        <div className="flex flex-row items-center justify-between gap-2 md:gap-6">
          <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0">
            ...
            <p className="text-[10px] md:text-sm text-gray-600 dark:text-slate-400 line-clamp-2">
              {language === "es" 
          ...
          <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
            <Button 
              ...
              className="h-7 md:h-9 px-2 md:px-4 text-[10px] md:text-sm border-gray-300 dark:border-slate-600"
            >
