...
export default function CTASection() {
  ...
  return (
    <section className="relative -mb-1 py-12 md:py-16 w-full bg-gradient-to-r from-blue-700 via-blue-500 to-cyan-400 rounded-t-3xl md:rounded-t-[2.5rem] overflow-hidden isolate">
