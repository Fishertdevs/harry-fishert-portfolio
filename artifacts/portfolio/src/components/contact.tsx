    ...
    <section id="contact" className="relative flex flex-col justify-center py-8 md:py-12 bg-white dark:bg-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2 md:mt-4">
        ...
        >
          ...
          <div className="h-3 sm:h-4 w-px bg-gray-300 dark:bg-slate-600 hidden sm:block"></div>
          <div className="flex items-center gap-1.5 sm:gap-2 text-gray-600 dark:text-slate-400">
        ...
        >
          <h3 className="text-sm sm:text-base font-semibold text-gray-700 dark:text-slate-300">
            {t("socialNetworks")}
          </h3>
          <div className="flex justify-center gap-4">
            <a 
              ...
              className="group w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-gray-100 dark:bg-slate-800 transition-all duration-300 hover:bg-[#181717] dark:hover:bg-[#f0f6fc] hover:scale-110"
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700 dark:text-slate-300 transition-colors duration-300 group-hover:text-white dark:group-hover:text-[#181717]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-gray-100 dark:bg-slate-800 transition-all duration-300 hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:scale-110"
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700 dark:text-slate-300 transition-colors duration-300 group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-gray-100 dark:bg-slate-800 transition-all duration-300 hover:bg-[#25D366] dark:hover:bg-[#25D366] hover:scale-110"
            >
